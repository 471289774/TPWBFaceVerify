...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TPWBFaceVerify.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/顾卫明/TPWBFaceVerify'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '顾卫明' => '471289774@qq.com' }
  s.source           = { :git => 'https://github.com/顾卫明/TPWBFaceVerify.git', :tag => s.version.to_s }
